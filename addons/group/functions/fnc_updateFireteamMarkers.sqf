 ...
 *
 * Example:
 * [] call arcmf_group_fnc_updateFireteamMarkers;
 *
 * Public: No
 */
...

{
    ...
    private _markerColor = ["ColorBlack","ColorRed","ColorGreen","ColorBlue","ColorYellow"] select (["MAIN","RED","GREEN","BLUE","YELLOW"] find assignedTeam _unit) max 0;
