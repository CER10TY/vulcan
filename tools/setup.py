...
def main():
    ...
    print("""
  ######################################
  # ARCMF3 Development Environment Setup #
  ######################################

  This script will create your ARCMF3 dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your ARCMF3 project folder:
    [Arma 3 installation directory]\\{} => ARCMF3 project folder
    P:\\{}                              => ARCMF3 project folder
